namespace CloudKids.Data.Migrations
{
    ...
    public partial class test : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        catreclamation = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ReunionPrives", "ParentFk", "dbo.Profils");
            DropForeignKey("dbo.ReunionPrives", "DirecteurFk", "dbo.Profils");
            ...
            DropIndex("dbo.ReunionPrives", new[] { "DirecteurFk" });
            DropIndex("dbo.ReunionPrives", new[] { "ParentFk" });
